...
import { ArrowLeft, ArrowRight, Search, Bot, ExternalLink } from "lucide-react";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="speakable-selector" content="#f2-objetivo, #f2-principios, #f2-checklist" />
      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Header del Módulo */}
            <header className="mb-12 text-center" id="modulo-f2">
              ...
              <ShareSectionButton sectionId="modulo-f2" title="Módulo F2" />
            </header>

            {/* Objetivo del Módulo */}
            <section id="f2-objetivo" className="mb-12">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-3xl font-semibold text-primary">Objetivo del Módulo</h2>
                <ShareSectionButton sectionId="f2-objetivo" title="objetivo F2" />
              </div>
            ...
            {/* Principios Clave */}
            <section id="f2-principios" className="mb-12">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-3xl font-semibold text-primary">Principios Clave del Módulo</h2>
                <ShareSectionButton sectionId="f2-principios" title="principios F2" />
              </div>
            ...
            {/* Pruebas y Ajustes */}
            <section id="f2-pruebas-ajustes" className="mb-12">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-3xl font-semibold text-primary">Pruebas y Ajustes Iterativos</h2>
                <ShareSectionButton sectionId="f2-pruebas-ajustes" title="pruebas F2" />
              </div>
            ...
            <section id="f2-checklist" className="mb-12">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-3xl font-semibold text-primary">Checklist de Implementación del Módulo F2</h2>
                <ShareSectionButton sectionId="f2-checklist" title="checklist F2" />
              </div>
            ...
            {/* Prompt para LLMs */}
            <section id="f2-prompt" className="mb-12">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-3xl font-semibold text-primary">Prompt para Implementación con LLMs</h2>
                <ShareSectionButton sectionId="f2-prompt" title="prompt F2" />
              </div>
              <p className="text-muted-foreground leading-relaxed mb-4">
...
Necesito que el contenido mantenga toda la información original pero optimizada para ser mejor comprendida por LLMs.`}
            ...
            <div className="flex justify-between items-center mb-16">
              ...
              <Button asChild>
                <Link to="/curso/f3">
                  Siguiente Módulo: F3 Autoridad Generativa
